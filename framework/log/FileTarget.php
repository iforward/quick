...
class FileTarget extends Target {
    ...
    public function init() {
        ...
        if ($this->logFile === null) {
            $this->logFile = Q::$app->getRuntimePath() . '/logs/app_'.date('Ymd').'.log';
        }
		else {
            $this->logFile = Q::getAlias($this->logFile);
        }
     ...
     * @throws Exception if unable to open the log file for writing
     */
